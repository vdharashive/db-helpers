...
test('lcr tests', async(t) => {
  ...
  try {
    ...
    t.ok(gateways[0].uri === 'sip:+4412838238238@3.3.3.3:5060', 'uses lcr when regex matches');
    ...
    gateways = await performLcr('4412838238238');
    //console.log(`gateways: ${JSON.stringify(gateways)}`);
    t.ok(gateways.length === 8 && gateways[7].uri === 'sip:4412838238238@10.10.10.10:5060', 'handles multiple carriers');
