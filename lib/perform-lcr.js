...
vc.requires_register, vc.register_username, vc.register_sip_realm, vc.register_password, vc.tech_prefix, vc.diversion  
...
async function performLcr(pool, logger, calledNumber) {
  ...
  r2.forEach((o) => {
    ...
    const obj = {
      uri: `sip:${prefix ? prefix : ''}${o.e164_leading_plus ? '+' : ''}${calledNumber}@${o.ipv4}:${o.port}`,
      name: o.name,
